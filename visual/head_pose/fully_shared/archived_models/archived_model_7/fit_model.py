...
while(current_epoch_number <= total_epoch_count):
	...
	MSE_train = hist.history['HP_regression_loss'][0]
	MAE_train = hist.history['HP_regression_mean_absolute_error'][0]
	crossentropy_train = hist.history['HP_classification_loss'][0]
	accuracy_train = hist.history['HP_classification_acc'][0]
