...
def load_training_data():
	...
	X = np.load('/home/syedcs15/depression_estimation/preprocessed_data/training_data/CLNF/preprocessed_pose_features/training_pose_features_scaled.npy')
...
def load_development_data():
	...
	X = np.load('/home/syedcs15/depression_estimation/preprocessed_data/development_data/CLNF/preprocessed_pose_features/development_pose_features_scaled.npy')
...
if __name__ == "__main__":
	X, Y, Y_class = load_training_data()
	print(X.shape)