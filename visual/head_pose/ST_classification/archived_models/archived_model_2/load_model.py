...
def load_model(location=None):
	...
	Y = CuDNNLSTM(6, name = 'classification_LSTM_1', return_sequences = True)(X)
	Y = CuDNNLSTM(5, name = 'classification_LSTM_2')(Y)
	...
	YC = Dense(4, activation = 'relu', name = 'classification_dense_1')(Y)
