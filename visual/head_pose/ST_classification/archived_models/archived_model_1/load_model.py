...
def load_model(location=None):
	...
	Y = CuDNNLSTM(18, name = 'classification_LSTM_1', return_sequences = True)(X)
	Y = CuDNNLSTM(15, name = 'classification_LSTM_2')(Y)
	...
	YC = Dense(12, activation = 'relu', name = 'classification_dense_1')(Y)
