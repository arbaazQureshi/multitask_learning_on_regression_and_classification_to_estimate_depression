...
def load_training_data():
	...
	X = np.load('data/training_pose_features_scaled.npy')
	...
	Y_class = np.load('data/Y_train_class.npy')
...
def load_development_data():
	...
	X = np.load('data/development_pose_features_scaled.npy')
	...
	Y_class = np.load('data/Y_dev_class.npy')
