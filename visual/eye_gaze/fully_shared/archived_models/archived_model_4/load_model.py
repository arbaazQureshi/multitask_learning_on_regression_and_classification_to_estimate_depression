...
def load_model(location=None):
	...
	Y = CuDNNLSTM(27, name = 'EG_shared_LSTM_1')(X)
	#Y = CuDNNLSTM(12, name = 'refression_LSTM_2')(Y)
	#Y = Dropout(rate = 3/9)(Y)

	#Y = Concatenate(axis = -1)([Y, X_gender])

	Y = Dense(25, activation = 'relu', name = 'EG_shared_dense_1')(Y)
	Y = Dropout(rate = 7/32)(Y)



	YR = Dense(10, activation = 'relu', name = 'EG_regression_dense_1')(Y)
	...
	YC = Dense(10, activation = 'relu', name = 'EG_classification_dense_1')(Y)
